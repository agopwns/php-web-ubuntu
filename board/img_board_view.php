        ...
        if($db){
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = mysqli_fetch_array($result)){
                    ...
                    echo "</div>";
                    echo "<div class='content-container' style='min-height: 200px; border-top: 1px solid white'>";
                    echo "<div style='padding-top: 10px;'><img src='$img_path' style='max-width: 1060px;'></div>";
                    echo "</div>";
                    echo "<div class='content-container' style='min-height: 100px; border-bottom: 1px solid white;'>";
